...
public class PropertiesUtils {
  ...
  private void load0(String fileName, LineReader lr) throws IOException {
    ...
    while ((limit = lr.readLine()) >= 0) {
      ...
      String oldValue = this.kvMap.put(key, value);
      if (oldValue != null) {
        throw new BusinessException("language put key repeat, key: " + key + ", path: " + fileName);
      }
    }
  }
