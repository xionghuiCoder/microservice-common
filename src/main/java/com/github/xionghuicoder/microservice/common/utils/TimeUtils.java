 ...
 * 功能 ：
 * <p>
 * Author: chengjinhui Data: 2018/3/02 Time: 13:19.
 * </p>
 */
public class TimeUtils {
   ...
   * @throws Exception Exception
   */
  public static Boolean judgeIfBeforeThanNow(String targetTime, String formatType)
      throws Exception {
  ...
  public static boolean judgeThisTimeRunOrNot(String startTime, String endTime) throws Exception {
    return judgeIfBeforeThanNow(startTime, dateFormatTYpe)
        && TimeUtils.judgeIfLaterThanNow(endTime, dateFormatTYpe);
  }
